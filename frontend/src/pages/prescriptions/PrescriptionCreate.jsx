...
const PrescriptionCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const request = await axios.post("http://localhost:8000/api/prescriptions", formInput, {
        headers: {
          ...
          <div className="">
            <div class="content-header my-3">
              <div class="d-flex align-items-center">
                <div class="me-auto">
                  <h4 class="page-title">Prescription Form</h4>
                  <div class="d-inline-block align-items-center">
                    <nav>
                      <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                        <li class="breadcrumb-item" aria-current="page">Prescriptions</li>
                        <li class="breadcrumb-item active" aria-current="page">Prescription's create form</li>
                      </ol>
                    </nav>
                  </div>
                </div>
            ...
            <div className="card">
              <div className="card-header">
                <h4 className="card-title">Add New Prescription</h4>
              </div>
              <div className="card-body">
                ...
                <form action method="post" encType='multipart/formdata' onSubmit={handleSubmit}>
                  <div className="form-group-element my-2">
                    ...
                    <input type="text" className="form-control" name="name" placeholder="Enter prescription's name..." onChange={handleChange} min={0} required />
                  ...
                  <div className="buttons my-2 mt-4 d-flex align-items-center gap-2 justify-content-end">
                    <button className="btn btn-success" disabled={isLoading}>
                      {isLoading ? "Adding Prescription" : "Add Prescription"}
                    </button>
